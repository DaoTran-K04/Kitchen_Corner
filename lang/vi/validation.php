...
return [
    ...
    */
    ...
    'custom' => [
        ...
        'author' => [
            'required' => 'Vui lòng nhập tên đầu bếp.',
        ],
        'author_name' => [
            'required' => 'Vui lòng nhập tên đầu bếp.',
        ],
        ...
        'cover_image' => [
            'image' => 'Ảnh món ăn phải là hình ảnh.',
            'mimes' => 'Ảnh món ăn phải có định dạng: :values.',
            'max' => 'Kích thước ảnh món ăn không được vượt quá :max KB.',
        ],
        'cover_image_url' => [
            'url' => 'URL ảnh món ăn không hợp lệ.',
        ],
        'tag' => [
    ...
    */
    ...
    'attributes' => [
        ...
        'content' => 'Nội dung',
        'author' => 'Đầu bếp',
        'author_name' => 'Tên đầu bếp',
        'email' => 'Email',
        'password' => 'Mật khẩu',
        'thumbnail' => 'Ảnh đại diện',
        'thumbnail_url' => 'URL ảnh đại diện',
        'cover_image' => 'Ảnh món ăn',
        'cover_image_url' => 'URL ảnh món ăn',
        'image' => 'Hình ảnh',
