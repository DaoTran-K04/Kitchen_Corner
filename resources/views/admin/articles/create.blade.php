        ...
        <form action="{{ route('admin.articles.store') }}" method="POST" enctype="multipart/form-data" id="article-form">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="space-y-4">
                    {{-- Ảnh bìa với Tabs --}}
                    <div>
                        <label class="block text-sm font-bold text-gray-700 dark:text-slate-300 mb-2">Ảnh bìa
                        ...
                        <div class="mb-3">
                            ...
                            <div class="min-h-[100px]">
                                ...
                                <div id="upload-url" class="hidden">
                                    <input type="url" name="thumbnail_url" id="image-url" value="{{ old('thumbnail_url') }}"
                                        oninput="previewUrl()"
                    ...
                    <div class="pt-2">
                        <label
                            ...
                            {{-- Toggle Switch --}}
                            <div class="relative">
                                <input type="checkbox" name="is_featured" id="toggle-featured" {{ old('is_featured') ? 'checked' : '' }} class="sr-only peer">
                                <div
                    ...
                    <div>
                        <label
                            ...
                            {{-- Toggle Switch --}}
                            <div class="relative">
                                <input type="checkbox" name="is_active" id="toggle-active" {{ old('is_active', true) ? 'checked' : '' }} class="sr-only peer">
                                <div
