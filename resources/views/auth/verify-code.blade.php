...
<head>
    ...
    <title>Xác Thực Mã - Góc Bếp</title>
    ...
    <div class="max-w-md w-full bg-white/95 backdrop-blur-xl rounded-3xl shadow-2xl overflow-hidden border border-white/20 relative z-10">
        <div class="p-8 text-center text-white relative overflow-hidden">
            ...
            <div class="relative z-10">
                ...
                <h2 class="text-2xl font-serif font-bold tracking-wide drop-shadow-md">Nhập Mã Xác Thực</h2>
                <p class="text-white/90 text-sm mt-2 font-light">Chúng tôi đã gửi mã 6 số vào email của bạn</p>
            </div>
        </div>
        ...
        <div class="p-8 md:p-10 bg-white">
            ...
            <div class="text-center mb-8">
                <p class="text-gray-600 text-sm bg-gray-50 py-3 rounded-xl border border-gray-100">
                    Mã đã được gửi đến <br><span class="font-bold text-brand-green text-base">{{ session('reset_email') ?? $email ?? '' }}</span>
                </p>
            </div>
            ...
            <div class="text-center mt-6">
                <a href="{{ route('password.request') }}" class="text-gray-400 hover:text-gray-600 text-sm transition duration-300 flex items-center justify-center gap-2 group">
