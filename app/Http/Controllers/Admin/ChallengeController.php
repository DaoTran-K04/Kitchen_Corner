...
class ChallengeController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validated = $request->validate([
            ...
            'action_type' => 'required|in:post_recipe,post_comment',
            ...
            'target_count.required' => 'Vui lòng nhập số lượng yêu cầu.',
            'target_count.min' => 'Số lượng yêu cầu phải ít nhất là 1.',
